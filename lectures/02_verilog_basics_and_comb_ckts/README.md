...
1. Introduce Verilog as a language for describing hardware.
2. Read a module: module name, ports, inputs, outputs, and `logic` signals.
3. Explain bit widths and unsigned integer values.
